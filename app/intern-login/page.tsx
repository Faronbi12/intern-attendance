          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className={`${fraunces.className} text-[#2B211A] text-lg`}>
                {isSignUp ? "Create intern account" : "Intern login"}
              </h1>
              <p className={`${plex.className} text-[#8A7A63] text-xs`}>Intern Attendance Portal</p>
            </div>
          </div>

          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              <label className={`${plex.className} text-xs text-[#8A7A63]`}>Email address</label>
